...
export const CursorDemo = ({
  ...
  return (
    <div
      key={String(global)}
      className="max-w-[400px] h-[400px] w-full bg-accent flex items-center justify-center cursor-none" // cursor-none hides default cursor
    >
      <p className="font-medium italic text-muted-foreground absolute">
